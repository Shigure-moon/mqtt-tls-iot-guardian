 ...
 * 
 * 主题规范：
 * - 设备状态: devices/esp8266-lock/status
 * - 传感器数据: devices/esp8266-lock/sensor
 * - 控制命令: devices/esp8266-lock/control
 * - 告警信息: devices/esp8266-lock/alerts
 * - 心跳: devices/esp8266-lock/heartbeat
 * 
 * 所需库：
 * - ESP8266WiFi
...
// ====== 设备配置 ======
#define DEVICE_ID "esp8266-lock"              // 设备唯一ID
#define DEVICE_NAME "esp8266-lock"          // 设备名称（屏幕显示用）
 ...
 *    - 控制命令: devices/esp8266-lock/control
 *    - 心跳: devices/esp8266-lock/heartbeat
 *    - 告警: devices/esp8266-lock/alerts
 * 
 * 4. 消息格式：
 *    - 使用JSON格式
 *    - 包含device_id和时间戳
