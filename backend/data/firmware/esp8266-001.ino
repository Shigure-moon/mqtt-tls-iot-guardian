 ...
 * 
 * 主题规范：
 * - 设备状态: devices/esp8266-001/status
 * - 传感器数据: devices/esp8266-001/sensor
 * - 控制命令: devices/esp8266-001/control
 * - 告警信息: devices/esp8266-001/alerts
 * - 心跳: devices/esp8266-001/heartbeat
 * 
 * 所需库：
 * - ESP8266WiFi
...
// ====== 设备配置 ======
#define DEVICE_ID "esp8266-001"              // 设备唯一ID
#define DEVICE_NAME "esp8266-001"          // 设备名称（屏幕显示用）
