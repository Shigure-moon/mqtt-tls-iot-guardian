 ...
 * 
 * 主题规范：
 * - 设备状态: devices/test-device/status
 * - 传感器数据: devices/test-device/sensor
 * - 控制命令: devices/test-device/control
 * - 告警信息: devices/test-device/alerts
 * - 心跳: devices/test-device/heartbeat
 * 
 * 所需库：
 * - ESP8266WiFi
...
// ====== 设备配置 ======
#define DEVICE_ID "test-device"              // 设备唯一ID
#define DEVICE_NAME "测试设备"          // 设备名称（屏幕显示用）

// WiFi配置
const char* ssid = "test-wifi";            // WiFi网络名称
const char* password = "test-pass";    // WiFi密码
