 ...
 * 
 * 主题规范：
 * - 设备状态: devices/encrypted-test-001/status
 * - 传感器数据: devices/encrypted-test-001/sensor
 * - 控制命令: devices/encrypted-test-001/control
 * - 告警信息: devices/encrypted-test-001/alerts
 * - 心跳: devices/encrypted-test-001/heartbeat
 * 
 * 所需库：
 * - ESP8266WiFi
...
// ====== 设备配置 ======
#define DEVICE_ID "encrypted-test-001"              // 设备唯一ID
#define DEVICE_NAME "加密烧录测试设备"          // 设备名称（屏幕显示用）
 ...
 *    - 控制命令: devices/encrypted-test-001/control
 *    - 心跳: devices/encrypted-test-001/heartbeat
 *    - 告警: devices/encrypted-test-001/alerts
 * 
 * 4. 消息格式：
 *    - 使用JSON格式
 *    - 包含device_id和时间戳
